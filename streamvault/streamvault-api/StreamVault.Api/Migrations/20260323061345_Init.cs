        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetUSD = table.Column<long>(type: "INTEGER", nullable: true),
                    RevenueUSD = table.Column<long>(type: "INTEGER", nullable: true),
                    GenresCsv = table.Column<string>(type: "TEXT", nullable: true),
                    ZonesCsv = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DroppedAtEpisode = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserContentStatuses", x => new { x.UserId, x.ContentId });
                    table.ForeignKey(
                        name: "FK_UserContentStatuses_Contents_ContentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contents_ExternalId_Source",
                table: "Contents",
                columns: new[] { "ExternalId", "Source" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserContentStatuses_ContentId",
                table: "UserContentStatuses",
                column: "ContentId");
        }
